...
class queryDatabase_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testQueryDatabase()
    {
        ...
        $whereClause = "patent.number like ? ";
        $whereValues = array("840790%");
        ...
        $results = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause, $whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs);
    ...
    public function testQueryDatabase_EmptyWhere()
    {
        ...
        $results = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause, array(), $whereFieldsUsed, array(), true, $selectFieldsSpecs, null, $options);
    ...
    public function testQueryDatabaseWithPaging()
    {
        global $PATENT_ENTITY_SPECS;
        global $PATENT_FIELD_SPECS;
        $whereClause = "patent.patent_id like ?";
        $whereValues=array("84%");
        $whereFieldsUsed = array('patent_id');
        $selectFieldsSpecs = array(
            'patent_id' => $PATENT_FIELD_SPECS['patent_id'],
            'patent_type' => $PATENT_FIELD_SPECS['patent_type'],
        ...
        $resultsFirst = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause,$whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs, null, $options);
        $options = array('page' => 11, 'per_page' => 25);
        $resultsSecond = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause,$whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs, null, $options);
        $options = array('page' => 6, 'per_page' => 50);
        $resultsThird = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause,$whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs, null, $options);
    ...
    public function testQueryDatabaseWithSorting()
    {
        ...
        $dbQuery = new DatabaseQuery();
        $results = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, $whereClause,$whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs, $sort);
        $encoded = json_encode($results);
    ...
    public function testQueryDatabaseWithInvalidSorting()
    {
        global $PATENT_ENTITY_SPECS;
        global $PATENT_FIELD_SPECS;
        $whereClause = "patent.patent_number like ?";
        $whereValues = array("820260%");
        $whereFieldsUsed = array('patent_id');
    ...
    public function testQueryDatabaseAllFields()
    {
        ...
        $results = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, null, array(), array(), array(), true, $selectFieldSpecs, null);
        $memUsed = memory_get_usage();
    ...
    public function testQueryDatabaseAllFieldsMaxPageSize()
    {
        ...
        $dbQuery = new DatabaseQuery();
        $memUsed = memory_get_usage();
        $results = $dbQuery->queryDatabase($PATENT_ENTITY_SPECS, $PATENT_FIELD_SPECS, null, array(), array(), array(), true, $selectFieldSpecs, null, $options);
        $memUsed = memory_get_usage();
    ...
    public function testQueryDatabaseInventorCombo1()
    {
        ...
        $whereClause = "patent.date >= ?";
        $whereValues =array('2007-01-04');
        ...
        $dbQuery = new DatabaseQuery();
        $results = $dbQuery->queryDatabase($INVENTOR_ENTITY_SPECS, $INVENTOR_FIELD_SPECS, $whereClause, $whereValues, $whereFieldsUsed, array(), true, $selectFieldsSpecs, $sort);
        $encoded = json_encode($results);
    ...
    public function testQueryDatabaseInventorWithSorting()
    {
        global $INVENTOR_ENTITY_SPECS;
        global $INVENTOR_FIELD_SPECS;
        $whereClause = "inventor.name_last like ?";
        $whereValues =array('You%');
