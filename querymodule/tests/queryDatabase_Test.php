...
class queryDatabase_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testQueryDatabase()
    {
        ...
        $results = $dbQuery->queryDatabase($whereClause, $whereFieldsUsed, $selectFieldsSpecs);
    ...
    public function testQueryDatabase_EmptyWhere()
    {
        ...
        $results = $dbQuery->queryDatabase($whereClause, $whereFieldsUsed, $selectFieldsSpecs, null, $options);
    ...
    public function testQueryDatabaseWithPaging()
    {
        ...
        $resultsFirst = $dbQuery->queryDatabase($whereClause, $whereFieldsUsed, $selectFieldsSpecs, null, $options);
        $options = array('page'=>11, 'per_page'=>25);
        $resultsSecond = $dbQuery->queryDatabase($whereClause, $whereFieldsUsed, $selectFieldsSpecs, null, $options);
        $options = array('page'=>6, 'per_page'=>50);
        $resultsThird = $dbQuery->queryDatabase($whereClause, $whereFieldsUsed, $selectFieldsSpecs, null, $options);
