...
$CPC_ENTITY_SPECS = array(
    ...
    array('entity_name'=>'uspc', 'group_name'=>'uspcs', 'keyId'=>'uspc_id', 'join'=>'left outer join uspc_current on cpc_current.patent_id=uspc_current.patent_id')
);
...
(
    ...
    'assignee_years_active' => array('entity_name'=>'assignee', 'table' => 'assignee', 'column_name' => 'years_active', 'datatype' => 'int', 'sort' => 'n'),
    'inventor_city' => array('entity_name'=>'inventor', 'table' => 'inventor_location', 'column_name' => 'city', 'datatypering', 'sort' => 'n'),
    'cpc_group_id' => array('entity_name'=>'cpc_subgroup', 'table' => 'cpc_current', 'column_name' => 'group_id', 'datatype' => 'string', 'sort' => 'y'),
    'cpc_group_title' => array('entity_name'=>'cpc_subgroup', 'table' => 'cpc_current', 'column_name' => 'group_title', 'datatype' => 'string', 'sort' => 'y'),
    ...
    'cpc_subgroup_id' => array('entity_name'=>'cpc_subgroup', 'table' => 'cpc_current', 'column_name' => 'subgroup_id', 'datatype' => 'string', 'sort' => 'y'),
    'cpc_subgroup_title' => array('entity_name'=>'cpc_subgroup', 'table' => 'cpc_current', 'column_name' => 'subgroup_title', 'datatype' => 'string', 'sort' => 'y'),
