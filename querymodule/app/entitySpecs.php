...
$PATENT_ENTITY_SPECS = array(
    ...
    array('entity_name'=>'inventor', 'group_name'=>'inventors', 'keyId'=>'inventor_id', 'table'=>'inventor', 'join'=>'left outer JOIN patent_inventor ON patent.patent_number=patent_inventor.patent_number left outer JOIN inventor ON patent_inventor.inventor_id=inventor.inventor_id left outer join inventor_location ON inventor.inventor_id=inventor_location.inventor_id'),
    array('entity_name'=>'assignee', 'group_name'=>'assignees', 'keyId'=>'assignee_id', 'table'=>'assignee', 'join'=>'left outer join patent_assignee on patent.patent_number=patent_assignee.patent_number left outer join assignee ON patent_assignee.assignee_id=assignee.assignee_id left outer JOIN assignee_location on assignee.assignee_id=assignee_location.assignee_id'),
    array('entity_name'=>'application', 'group_name'=>'applications', 'keyId'=>'app_id', 'table'=>'application', 'join'=>'left outer join application on patent.patent_number=application.patent_number'),
    array('entity_name'=>'ipc', 'group_name'=>'IPCs', 'keyId'=>'', 'table'=>'ipcr', 'join'=>'left outer join ipcr on patent.patent_number=ipcr.patent_number'),
    array('entity_name'=>'applicationcitation', 'group_name'=>'application_citations', 'keyId'=>'', 'table'=>'usapplicationcitation', 'join'=>'left outer join usapplicationcitation on patent.patent_number=usapplicationcitation.patent_number'),
    array('entity_name'=>'cited_patent', 'group_name'=>'cited_patents', 'keyId'=>'', 'table'=>'uspatentcitation', 'join'=>'left outer join uspatentcitation on patent.patent_number=uspatentcitation.citing_patent_number'),
    //Todo: Figure out difference between uspatentcitation and uscitedpatent and if both are needed.
    array('entity_name'=>'citedby_patent', 'group_name'=>'citedby_patents', 'keyId'=>'', 'table'=>'uscitedpatent', 'join'=>'left outer join uscitedpatent as uscitedpatent on patent.patent_number=uscitedpatent.cited_patent_number'),
    //Todo: Do we need both the uspc and uspc_current?
    array('entity_name'=>'uspc', 'group_name'=>'uspcs', 'keyId'=>'uspc_id', 'table'=>'uspc_current', 'join'=>'left outer join uspc_current on patent.patent_number=uspc_current.patent_number')
);

// These could be stored in a database instead of hardcoded here.
$PATENT_FIELD_SPECS = array
(
    'patent_id' => array('entity_name'=>'patent', 'table' => 'patent', 'field_name' => 'patent_number', 'datatype' => 'string'),
    ...
    'citedby_patent_number' => array('entity_name'=>'citedby_patent', 'table' => 'uscitedpatent', 'field_name' => 'citing_patent_number', 'datatype' => 'string'),
    ...
    'cited_patent_number' => array('entity_name'=>'cited_patent', 'table' => 'uspatentcitation', 'field_name' => 'cited_patent_number', 'datatype' => 'string'),
    ...
    'patent_number' => array('entity_name'=>'patent', 'table' => 'patent', 'field_name' => 'patent_number', 'datatype' => 'string'),
