...
(
    ...
    'application_date' => array('table' => 'application', 'field_name' => 'date', 'datatype' => 'string'),
    ...
    'applicationcitation_date' => array('table' => 'usapplicationcitation', 'field_name' => 'date', 'datatype' => 'string'),
    ...
    'applicationcitation_sequence' => array('table' => 'usapplicationcitation', 'field_name' => 'sequence', 'datatype' => 'string'),
...
//    'inventor_nationality' => array('table' => 'inventor_flat', 'field_name' => 'inventor_nationality', 'datatype' => 'string'),
    'inventor_state' => array('table' => 'inventor_flat', 'field_name' => 'state', 'datatype' => 'string'),
    'ipc_action_date' => array('table' => 'ipcr', 'field_name' => 'action_date', 'datatype' => 'string'),
    ...
    'ipc_sequence' => array('table' => 'ipcr', 'field_name' => 'sequence', 'datatype' => 'string'),
    ...
    'patent_abstract' => array('table' => 'patent', 'field_name' => 'abstract', 'datatype' => 'string'),
    'patent_country' => array('table' => 'patent', 'field_name' => 'country', 'datatype' => 'string'),
    'patent_date' => array('table' => 'patent', 'field_name' => 'date', 'datatype' => 'string'),
    'patent_kind' => array('table' => 'patent', 'field_name' => 'Kind', 'datatype' => 'string'),
    'patent_num_claims' => array('table' => 'patent', 'field_name' => 'num_claims', 'datatype' => 'string'),
    'patent_number' => array('table' => 'patent', 'field_name' => 'number', 'datatype' => 'string'),
    'patent_title' => array('table' => 'patent', 'field_name' => 'title', 'datatype' => 'string'),
    ...
    'patentcitation_date' => array('table' => 'uspatentcitation', 'field_name' => 'date', 'datatype' => 'string'),
    ...
    'patentcitation_sequence' => array('table' => 'uspatentcitation', 'field_name' => 'sequence', 'datatype' => 'string'),
    ...
    'uspc_sequence' => array('table' => 'uspc_flat', 'field_name' => 'sequence', 'datatype' => 'string'),
