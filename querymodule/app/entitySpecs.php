...
$PATENT_ENTITY_SPECS = array(
    ...
    array('entity_name'=>'application', 'group_name'=>'applications', 'keyId'=>'application_id', 'table'=>'application', 'join'=>'left outer join application on patent.id=application.patent_id'),
    array('entity_name'=>'ipc', 'group_name'=>'IPCs', 'keyId'=>'ipc_id', 'table'=>'ipcr', 'join'=>'left outer join ipcr on patent.id=ipcr.patent_id'),
    array('entity_name'=>'applicationcitation', 'group_name'=>'application_citations', 'keyId'=>'applicationcitation_id', 'table'=>'usapplicationcitation', 'join'=>'left outer join usapplicationcitation on patent.id=usapplicationcitation.patent_id'),
    array('entity_name'=>'patentcitation', 'group_name'=>'patent_citations', 'keyId'=>'patentcitation_id', 'table'=>'uspatentcitation', 'join'=>'left outer join uspatentcitation on patent.id=uspatentcitation.patent_id'),
...
(
    ...
    'application_id' => array('entity_name'=>'application', 'table' => 'application', 'field_name' => 'id', 'datatype' => 'string'),
    'ipc_id' => array('entity_name'=>'ipc', 'table' => 'ipcr', 'field_name' => 'uuid', 'datatype' => 'string'),
    'applicationcitation_id' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'uuid', 'datatype' => 'string'),
    'patentcitation_id' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'uuid', 'datatype' => 'string'),
    ...
    'application_country' => array('entity_name'=>'application', 'table' => 'application', 'field_name' => 'country', 'datatype' => 'string'),
    'application_date' => array('entity_name'=>'application', 'table' => 'application', 'field_name' => 'date', 'datatype' => 'date'),
    'application_number' => array('entity_name'=>'application', 'table' => 'application', 'field_name' => 'number', 'datatype' => 'string'),
    'application_type' => array('entity_name'=>'application', 'table' => 'application', 'field_name' => 'type', 'datatype' => 'string'),
    'applicationcitation_category' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'category', 'datatype' => 'string'),
    'applicationcitation_date' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'date', 'datatype' => 'date'),
    'applicationcitation_kind' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'kind', 'datatype' => 'string'),
    'applicationcitation_name' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'name', 'datatype' => 'string'),
    'applicationcitation_sequence' => array('entity_name'=>'applicationcitation', 'table' => 'usapplicationcitation', 'field_name' => 'sequence', 'datatype' => 'int'),
    ...
    'patentcitation_category' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'category', 'datatype' => 'string'),
    'patentcitation_date' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'date', 'datatype' => 'date'),
    'patentcitation_kind' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'kind', 'datatype' => 'string'),
    'patentcitation_name' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'name', 'datatype' => 'string'),
    'patentcitation_sequence' => array('entity_name'=>'patentcitation', 'table' => 'uspatentcitation', 'field_name' => 'sequence', 'datatype' => 'int'),
